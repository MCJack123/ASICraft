...
public class ChaCha20DecodeAlgorithm implements IAlgorithm {
    ...
    public void input(IArguments args, IAlgorithmPartialResultCallback callback) throws LuaException {
        ...
        if (cipher == null) {
            try {
                ...
                cipher.init(Cipher.DECRYPT_MODE, skey, new ChaCha20ParameterSpec(nonce, 1));
            } catch (Exception e) {
                cipher = null;
